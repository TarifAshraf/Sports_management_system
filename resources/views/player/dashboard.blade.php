            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-warning">
                    <div class="inner">
                        ...
                        <h3>
                            @php
                                $name = DB::table('sponsors')->where('sid', $data->sponsor)->pluck('sname')->first();
                            @endphp
                            {{ $name }}
                        </h3>
                        @else
...
<section class="content">
    <div class="container">
        <div class="jumbotron" style="box-shadow: 20px 20px 50px grey; background: white">
            <form method="POST" action="{{ route('playerSaveInfo') }}">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-4 pt-3">
                        ...
                        <input type="text" name="pname" class="form-control" required value="{{ Auth()->user()->name }}">
                    </div>
                    <div class="col-lg-4 pt-3">
                        <label for="">Age</label>
