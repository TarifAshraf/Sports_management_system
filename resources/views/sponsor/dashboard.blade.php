...
<section class="content">
    <div class="container">
        <div class="jumbotron" style="box-shadow: 20px 20px 50px grey; background: white">
            <form method="POST" action="{{ route('sponsorSaveinfo') }}">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-4 pt-3">
                        ...
                        <input type="text" name="sname" class="form-control" required value="{{ Auth()->user()->name }}">
                    </div>
                    <div class="col-lg-4 pt-3">
                        <label for="">Net Worth</label>
                        <input type="number" name="networth" class="form-control" required >
                    </div>
                    <div class="col-lg-4 pt-3">
